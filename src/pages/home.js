    ...
    return (
        <div className="home">
            <div className="text">
                ...
                <p> Outside of computer science, I enjoy in cooking/trying new foods, working out and staying active, and watching comedies.  Feel free to reach out to me ezhu46@gatech.edu!</p>
            </div>
